...
//   let input = document.getElementById("myTextId").focus();
// });
...
tabel();
function tabel(){
  let level = $('#select_level_user').val();
  let dataTable = $('#tabel_serverside').DataTable( {
    "processing" : true,
    "oLanguage": {
    ...
    "scrollX": true,
    "ajax":{
      "url" :base_url+"adm/data_administrator" , // json datasource
...
$('#tabel_serverside').on('click','.resetPassword',function(){
  ...
  Swal.fire({
    ...
    $.ajax({
      type : "POST",
      url  : base_url+'/adm/reset_password',
      async : false,
      // dataType : "JSON",
...
$('#tabel_serverside').on('click','.aktifkanstatus',function(){
  ...
  $.ajax({
    type : "POST",
    url  : base_url+"adm/ubah_status_user",
    async : false,
...
$('#tabel_serverside').on('click','.ubah_level_user',function(){
  ...
  Swal.fire({
    ...
    $.ajax({
      type : "POST",
      url  : base_url+'/adm/ubah_level_user',
      async : false,
      // dataType : "JSON",
